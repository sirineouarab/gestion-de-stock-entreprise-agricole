    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.centre')),
            ],
        ),
        migrations.CreateModel(
            name='Avance',
            fields=[
                ...
                ('employe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.employe')),
            ],
        ),
        migrations.CreateModel(
            name='Absence',
            fields=[
                ('codeAb', models.AutoField(primary_key=True, serialize=False)),
                ('dateAbsence', models.DateField()),
                ('emp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.employe')),
            ],
        ),
        migrations.CreateModel(
            name='Reglement',
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.client')),
            ],
        ),
        migrations.CreateModel(
            name='TransfertRecu',
            fields=[
                ...
                ('centre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.centre')),
                ('produitTr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfertrecu_produit_tr3', to='magasin.produit')),
            ],
        ),
        migrations.CreateModel(
            name='Vente',
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.client')),
                ('produit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.produit')),
            ],
        ),
        migrations.CreateModel(
            name='CreditPayment',
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.client')),
                ('vente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre3.vente')),
            ],
        ),
    ]
