    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre.creditpayment')),
            ],
        ),
        migrations.CreateModel(
            name='TransfertRecu',
        ...
        migrations.AddField(
            ...
            name='vente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='centre.vente'),
        ),
    ]
